//! Optional AIR-declared buffer reach, independent of native PSO reflection.
//!
...
/// A particular shader stage and slot's proved reach, never a native length.
#[derive(Clone, Copy)]
...
impl BufferExtents {
    pub(crate) fn bound(&self, index: u32) -> Option<BoundedRead> {
