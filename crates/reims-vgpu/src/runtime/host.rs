...
impl crate::observe::Decline for MemError {
    fn slug(&self) -> &'static str {
        match self {
            ...
            Self::Unresolved(status) => match crate::protocol::gva_resolve::walk_refusal(status) {
                Some(slug) => slug,
...
pub const GUEST_PAGE_SIZE_ARM64E: usize = 1usize << crate::protocol::gva::PAGE_SHIFT_ARM64E;
...
mod tests {
    ...
    fn a_guest_page_smaller_than_the_hosts_maps_to_its_own_bytes() {
        const X86_PAGE: usize = 1usize << crate::protocol::gva::PAGE_SHIFT_X86;
        let mut h = FakeHost::new();
